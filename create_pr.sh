...
for FILE in $CHANGED_FILES; do
  REPO="github.com/khulnasoft-lab/vuln-list-k8s"
 ...
 ## if gh pr list --state open --repo "github.com/khulnasoft-lab/vuln-list-k8s" | grep -q "No open pull requests"; then
    open_pr_count=$(gh pr list --state open --base main --repo  github.com/khulnasoft-lab/vuln-list-k8s  | grep $FILE | wc -l)
